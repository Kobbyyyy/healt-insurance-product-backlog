...
**Sprint 4 Planning Date/Time:** March 12, 2026 - 10:00 AM
...
**Sprint 4 Goal:** *"Deliver a functional risk calculator with GitHub setup, user input form with validation, and core API endpoint."*

---

##  Sprint 4 Commitment (24 Points)

| **ID** | **User Story / Task** | **Priority (1-10)** | **Estimate (SP)** | **Spike (Y/N)** | **Status** | **Assigned** |
|--------|------------------------|--------------|--------------|------------|--------------|--------------|
| RC-001 | As a Scrum Team, we want to identify the Sprint 4 Scrum Master and Product Owner so that I can ensure team responsibilities are clearly defined for the sprint. | 10 | 0 | N | Done | Fernando, Nana |
...
For a story to be considered "Done" in Sprint 4:
